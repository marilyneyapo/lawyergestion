 ...
 */
final class Version20241119105623 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE audience DROP renvois');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE audience ADD renvois JSON DEFAULT NULL COMMENT \'(DC2Type:json)\'');
    }
}
